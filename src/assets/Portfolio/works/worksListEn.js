        ...
        Development: [
            {
                ...
                description:
                    'Mando is a merchant software themed on The Mandalorian series developed in C# with SQL Server (ADO).',
                tools: 'C#, SQL Server',
            ...
            },
            {
                ...
                description:
                    'Charlemagne is a takeaway website for Le Charlemagne training restaurant at Pointet High School located in Thann.',
            ...
            },
            {
                ...
                img: w.WeebLampe,
                banner: w.WLBanner,
                description: 'Weeb Lampe is a merchant website for anime-themed lamps.',
                tools: 'PHP, MySQL',
            },
            {
            ...
            },
            {
                ...
                img: w.Charlemagne,
                banner: w.CharlemagneResBanner,
                description:
                    'Reservation website for Le Charlemagne training restaurant at Pointet High School located in Thann.',
                tools: 'React, NodeJS, Express, MongoDB',
                doc: 'https://github.com/Nahay/charlemagne-reservation-client/wiki',
            },
            {
                title: 'Weeb Battle',
        ...
        'Web Design': [
            {
                ...
                img: w.AdobeXd,
                banner: w.PortfolioBanner,
                description: 'Model created for the design of this Portfolio.',
                tools: 'Adobe Xd, Adobe Photoshop',
                url: 'https://drive.google.com/file/d/1qF_FWHLUbSyRki7eXHW791PPrtkX-KEu/view?usp=sharing',
            },
            {
                title: 'Project Model',
                img: w.Figma,
                banner: w.ProjectBanner,
        ...
        Illustration: [
            {
                ...
                banner: w.EldenRing,
                description:
                    'Presentation brochure of the game Elden Ring produced by the studio From Software. (pretty good game!)',
