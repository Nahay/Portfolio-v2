...
const SIOAbout = () => {
    ...
    return ( 
        <div className='about' id='accueil'>
            ...
            >
                <h2 className='box__title'><span className='underline'>Bienvenue su</span>r mon portfolio</h2>
                
                <p>Je me présente : je m'appelle <b>Lily Barberou</b>.</p>
                    <br/>
                <p>
                    Je suis actuellement étudiante en <b>BTS SIO</b> Services Informatiques aux Organisations à Colmar en deuxième année.
                </p>
                    <br/>
                <p>
